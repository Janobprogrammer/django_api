...
class Answer(models.Model):
    teacher = models.ForeignKey("accounts.User", on_delete=models.CASCADE, default=None, related_name='part_3_answered_teacher')
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='part_3_answers')
...
class Idea(models.Model):
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='part_3_ideas')
...
class Vocabulary(models.Model):
    question = models.ForeignKey(Question, on_delete=models.CASCADE, related_name='part_3_vocabularies')
