...
class CandidatesAnswerSerializer(serializers.ModelSerializer):
...
class ExamSerializer(serializers.ModelSerializer):
    part1 = PartSerializer(read_only=True)
    part2 = PartSerializer(read_only=True)
    part3 = PartSerializer(read_only=True)
